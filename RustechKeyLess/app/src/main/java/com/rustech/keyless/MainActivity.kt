...
class MainActivity : AppCompatActivity() {
    ...
    ) { /* User can just retry the relevant switch if something was denied. */ }
    ...
    override fun onStart() {
        ...
        binding.switchBroadcast.isChecked = BeaconAdvertiseService.isRunning
    }
    ...
    private fun showTab(broadcast: Boolean) {
        ...
        binding.btnTabBroadcast.setTextColor(
            ContextCompat.getColor(this, if (broadcast) R.color.accent_green else R.color.text_secondary)
        )
        binding.btnTabScope.setTextColor(
            ContextCompat.getColor(this, if (!broadcast) R.color.accent_green else R.color.text_secondary)
        )
    }
    ...
    private fun pruneStaleBeacons() {
        ...
        val stale = beaconMap.filterValues { it.lastSeen < cutoff }.keys
